...
| METEO CONSULT 1.1.4 | **Meteo Consult: privacy mode** | Coupe les analytics applicatifs et Wysistat sans désactiver les initialisations nécessaires, la localisation ni les alertes météo. |
